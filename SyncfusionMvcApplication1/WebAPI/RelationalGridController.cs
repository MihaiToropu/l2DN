...
namespace SyncfusionMvcApplication1.WebAPI
{
    public class RelationalGridController : ApiController
    {
        ...
        public Dictionary<string, object> InitializeGrid(Dictionary<string, object> jsonResult)
        {
            ...
            htmlHelper.PivotReport = BindDefaultData((customData is Dictionary<string, object> && customData.ContainsKey("isCalculatedField")) ? customData["isCalculatedField"] : false);
        ...
        {
            htmlHelper.PopulateData(jsonResult["currentReport"].ToString());
            dict = htmlHelper.GetJsonData(jsonResult["action"].ToString(), ProductSales.GetSalesData(), null, null, null, jsonResult["filterParams"].ToString(), jsonResult["sortedHeaders"].ToString(), jsonResult["valueSorting"].ToString());
            return dict;
        }
