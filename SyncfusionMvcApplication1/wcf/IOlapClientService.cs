...
namespace SyncfusionMvcApplication1
{
    ...
    public interface IOlapClientService
    {
        ...
        [OperationContract]
        Dictionary<string, object> DrillChart(string action, string drilledSeries, string olapReport);
        [OperationContract]
        ...
        [OperationContract]
        Dictionary<string, object> DrillGrid(string action, string cellPosition, string currentReport, string headerInfo, string layout);
        [OperationContract]
